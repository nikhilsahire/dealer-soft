  ...
  <div class="col-md-12"> 
    ...
    <div class="portlet box grey-cascade">
      <div class="portlet-title">
        <div class="caption"> <i class="fa fa-globe"></i>Manage Transactions: <?php echo $supplier_name;?></span></div>
...
<?php  
			...
			echo form_open('payment/supplier_transactions/'.$supplier_id,$attributes);
 ...
 <div class="row" style="margin-top: 15px;">
  <!--</form>-->
   <div class="col-md-9">
	  <div class="form-group">
			  ...
			  <div class="col-md-4">
			  <strong>Total Debit Amount:</strong><br/><?php echo number_format($finalAmount[0]['po_amount'],2); ?>
			</div>
	 		 <div class="col-md-4">
			  <strong>Total Balance:</strong><br/><?php echo number_format(($finalAmount[0]['po_amount']-$finalAmount[0]['paid_amount']),2); ?>
			</div>
  ...
  <div class="form-group">
              ...
              <div class="btn-group" style="float:right;">
                <a href="<?php echo base_url();?>payment/add_supl_payment/<?php echo $supplier_id ?>"><button id="sample_editable_1_new" class="btn green"> New Transaction <i class="fa fa-plus"></i> </button></a>
