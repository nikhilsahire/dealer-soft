					...
					<div >
					  ...
					  ?>
						...
						<tr class="space_bottom">
							...
							<td class="hidden-480" ><?php  $orderTotal += $challanShippingDetails[0]['forwardingAmt'];
						...
						<tr class="space_bottom">
							...
							<td class="hidden-480" ><?php  $discountAmt = $challanShippingDetails[0]['discountAmt'];
					    ...
					    <tr class="space_bottom" >
							...
							<td style="border-bottom:1px solid #D6D6D6;" id="finalTotal" ><?php 
				...
				<div class="row" style="border:1px solid #D6D6D6; margin:10px 0;">
					...
					<div class="" >
						<div style="background:#ffffff;width:100%;">
							...
							<span style="font-weight:bold;">Commissionerate:</span> Nashik-1/ Old Agra Road, R G Gadkari Chowk, Nashik.					
							</span>
						</div>
