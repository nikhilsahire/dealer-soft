...
<?php  
			...
			echo form_open_multipart('workers/edit/'.$employee_details[0]['emp_id'],$attributes);
			...
			$data_emp_name = array(
						  		 'name'         => 'emp_name',
								  'id'          => 'emp_name',
								  'value'       => $employee_details[0]['emp_name'],
								  'class'		=> 'form-control',
								  'required' 	=> 'required',
								  'maxlength' => '50',
			...
			$data_emp_mobile = array(
						  		 'name'         => 'emp_mobile',
								  'id'          => 'emp_mobile',
								  'value'       => $employee_details[0]['emp_mobile'] ,
								  'class'		=> 'form-control',
								  'maxlength' => '25',
								  'required' 	=> 'required',
			...
			$data_emp_address = array(
						  		 'name'         => 'emp_address',
								  'id'          => 'emp_address',
								  'value'       => $employee_details[0]['emp_address'] ,
								  'class'		=> 'form-control',
								  'cols' => 20,
								  'rows'=> 5,
								 );	
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_dropdown('emp_status',$data_status,$employee_details[0]['emp_status'],'class="select2_category form-control" tabindex="0"');?>
