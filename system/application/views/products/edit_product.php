    ...
    <div class="portlet box green">
      ...
      <div class="portlet-body form"> 
       ...
       <?php  
			...
			echo form_open_multipart('products/edit/'.$product_details[0]['pid'],$attributes);
			...
			$data_item_code = array(
						  		 'name'         => 'item_code',
								  'id'          => 'item_code',
								  'value'       => $product_details[0]['item_code'],
			...
			$data_product_name = array(
						  		 'name'         => 'product_name',
								  'id'          => 'product_name',
								  'value'       => $product_details[0]['product_name'] ,
								  'max_length' => '150',
								  'class'		=> 'form-control',
								  'required' 	=> 'required',
			...
			$data_product_desc = array(
								  ...
								  'cols' => 40,
								  'rows'=> 5,
								  'value'       => $product_details[0]['product_desc'] ,
								  'class'		=> 'form-control',
			...
			$data_min_qty = array(
						  		 'name'         => 'min_qty',
								  'id'          => 'min_qty',
								  'value'       => $product_details[0]['min_qty'],
								  'class'		=> 'form-control',
								  'required' 	=> 'required',
								  'max_length' => '13',
	   ...
	   ?>
          <div class="form-body">
		  <input type="hidden" name="pid" id="pid" value="<?php echo $product_details[0]['pid']?>"  />
            <?php if(validation_errors()){ //echo '<pre>'; print_r(validation_errors()); ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">Product Unit<span class="required" aria-required="true"> *</span></label>
                     <?php echo form_dropdown('prod_unit',$data_prod_unit,$product_details[0]['prod_unit'],'class="select2_category form-control" tabindex="0"');?>
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
				  ...
				  echo form_dropdown('tax_free',$data_tax_free,$product_details[0]['tax_free'],'class="select2_category form-control" tabindex="0"');?> 
			    ...
			    <div class="form-group">
                  ...
                  <?php 
					...
					$data_sgst_per = array(
										 'name'         => 'sgst_per',
										  'id'          => 'sgst_per',
										  'value'       => $product_details[0]['sgst_per'] ,
										  'max_length' => '4',
										  'class'		=> 'form-control',
										  'required' 	=> 'required',
										  'type' 	=> 'number',
                ...
                <div class="form-group">
				  ...
				  $igst_per = set_value('igst_per');				  
					$data_igst_per = array(
										 'name'         => 'igst_per',
										  'id'          => 'igst_per',
										  'value'       => $product_details[0]['igst_per'] ,
										  'max_length' => '4',
										  'class'		=> 'form-control',
										  'required' 	=> 'required',
										  'type' 	=> 'number',
			    ...
			    <div class="form-group">
                  ...
                  <?php 
					...
					$data_cgst_per = array(
										 'name'         => 'cgst_per',
										  'id'          => 'cgst_per',
										  'value'       => $product_details[0]['cgst_per'] ,
										  'max_length' => '4',
										  'class'		=> 'form-control',
										  'required' 	=> 'required',
										  'type' 	=> 'number',
                ...
                <div class="form-group">
                  ...
                  <?php 
					...
					$data_selling_price = array(
										 'name'         => 'selling_price',
										  'id'          => 'selling_price',
										  'value'       => $product_details[0]['selling_price'] ,
										  'max_length' => '10',
										  'class'		=> 'form-control',
										  'required' 	=> 'required',
										  'type' 	=> 'number',
            ...
            <div class="row">              
                 ...
                 <div class="col-md-12">
				  ...
				  <?php echo $this->ckeditor->editor("product_desc",$product_details[0]['product_desc']); ?>
