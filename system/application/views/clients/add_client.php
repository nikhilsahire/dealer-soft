...
<?php  
			...
			echo form_open_multipart('client/add',$attributes);
...
<?php  
			...
			$primary_district =set_value('primary_district');
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_comp_name); ?>
                   <span class="help-block help-block-error" for="comp_name" style="color:#F30;"><?php echo form_error('comp_name'); ?></span>
                </div>
              </div>
              <!--/span-->
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_primary_contact); ?>
                   <span class="help-block help-block-error" for="primary_contact" style="color:#F30;"><?php echo form_error('primary_contact'); ?></span>
                </div>
              </div>
              <!--/span-->
			  <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_primary_email); ?>
                   <span class="help-block help-block-error" for="primary_phone" style="color:#F30;"><?php echo form_error('primary_email'); ?></span>
                </div>
              </div>
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_primary_phone); ?>
                   <span class="help-block help-block-error" for="primary_phone" style="color:#F30;"><?php echo form_error('primary_phone'); ?></span>
                </div>
              </div>
              <!--/span-->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_primary_mobile); ?>
                   <span class="help-block help-block-error" for="primary_mobile" style="color:#F30;"><?php echo form_error('primary_mobile'); ?></span>
                </div>
              </div>
              <!--/span--> 
            </div>			
			...
			<div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_textarea($data_shipping_address); ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_input($data_city); ?>
                  <span class="help-block help-block-error" for="city" style="color:#F30;"><?php echo form_error('city'); ?></span>
                </div>
              </div>
              <!--/span--> 
            </div>
             ...
             <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_textarea($data_notes); ?>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_textarea($data_other_information); ?>
                  <span class="help-block help-block-error" for="other_information" style="color:#F30;"><?php echo form_error('other_information'); ?></span>
                </div>
              </div>
              <!--/span--> 
            </div>
			...
			<div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <?php echo form_dropdown('status',$data_status,$status_data,'class="select2_category form-control" tabindex="0"');?>
